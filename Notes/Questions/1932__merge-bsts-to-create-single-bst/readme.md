...
<img alt="" src="d1.png" style="width: 450px; height: 163px;" />
<pre>
...
<img alt="" src="diagram.png" style="width: 450px; height: 181px;" />
In the second operation, pick i=0 and j=1, and merge trees[1] into trees[0].
Delete trees[1], so trees = [[3,2,5,1,null,4]].
<img alt="" src="diagram-2.png" style="width: 220px; height: 165px;" />
The resulting tree, shown above, is a valid BST, so return its root.</pre>

<p><strong>Example 2:</strong></p>
<img alt="" src="d2.png" style="width: 450px; height: 171px;" />
<pre>
...
<img alt="" src="diagram-3.png" style="width: 240px; height: 196px;" />
The resulting tree is shown above. This is the only valid operation that can be performed, but the resulting tree is not a valid BST, so return null.
</pre>

<p><strong>Example 3:</strong></p>
<img alt="" src="d3.png" style="width: 430px; height: 168px;" />
<pre>
